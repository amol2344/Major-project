            ...
            <div className="p-4">
              ...
              <nav className="space-y-1">
                {[
                  ...
                  { id: 'exercises', icon: <FiVideo />, label: 'My Exercises' },
              ...
              <div className="space-y-6">
                ...
                <div className="card p-6">
                  <div className="flex flex-col md:flex-row md:items-center md:justify-between">
                    <div>
                      ...
                      <p className="text-gray-600">Your recovery journey is progressing well!</p>
                    </div>
                ...
                <div className="card overflow-hidden">
                  ...
                  <div className="px-4 py-3 border-t border-gray-200 text-center">
                    <button className="text-blue-600 hover:text-blue-700 text-sm font-medium flex items-center justify-center w-full focus-ring">
