...
const ManageUsers = () => {
  ...
  const handleAddUser = () => {
    if (newUser.username && newUser.email && newUser.fullName) {
      ...
      setUsers([...users, user]);
      setNewUser({ username: '', email: '', fullName: '', role: 'patient', status: 'active' });
  ...
  const handleUpdateUser = () => {
    if (editingUser && newUser.username && newUser.email && newUser.fullName) {
              ...
              {filteredUsers.map((user) => (
                <tr key={user.id} className="hover:bg-gray-50">
                  ...
                  <td className="px-6 py-4 whitespace-nowrap">
                    ...
                    <div className="text-sm text-gray-500">Appointments: {user.appointments}</div>
                  </td>
